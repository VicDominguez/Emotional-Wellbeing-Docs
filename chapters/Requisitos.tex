...
\section{Descripción general del producto}
    ...
    \subsection{Restricciones generales}
        ...
        \todo[inline]{Alguna más que hayamos metido en las específicas?}
...
\section{Requisitos específicos}
    ...
    \subsection{Requisitos funcionales}
        ...
        \todo[inline]{Este orden nos fuerza a poner permiso extracción y visualización, y en el de analista decir que se envian y poco más. Tiene sentido que hablando de visualización digamos permiso y extracción?}
        ...
        \begin{enumerate}[resume=req-usuario,label=\textbf{\texttt{RU-\arabic*}}]
            ...
            %\begin{enumerate}[resume=req-funcionales,label=\textbf{\texttt{RF-\arabic*}}]
                \todo[inline]{Deriva únicamente en requisitos no funcionales? Tiene sentido tener un requisito de usuario que no deriva en funcionales?}
            %\end{enumerate}
        \end{enumerate}
        \begin{enumerate}[resume=req-usuario,label=\textbf{\texttt{RU-\arabic*}}]
