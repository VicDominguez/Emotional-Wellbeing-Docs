\chapter{[En revisión] Análisis del sistema propuesto}
...
\section{Descripción general del producto}
    ...
    \subsection{Dependencias}
        ...
        \begin{enumerate}[label=\textbf{DEP-\arabic*}]
            ...
            \todo[inline]{Reescritura completada de esta dependencia}
    ...
    \subsection{Requisitos funcionales}
        ...
        \begin{enumerate}[series=req-usuario,label=\textbf{\texttt{RU-\arabic*}}]
            ...
            \begin{enumerate}[series=req-funcionales,label=\textbf{\texttt{RF-\arabic*}}]
                ...
                \todo[inline]{V: Decimos aqui que ese cuestionario se encuentra en el Anexo X o ya en diseño?}
                ...
                \item  El sistema desplegará un cuestionario vespertino diario de estrés sobre las 21:00 hora local del usuario, recogiendo la información definida en \ref{req:info_estres_diario} relativa al día en su totalidad.                \todo[inline]{V: Si quitamos la info de puntual en el primer requisito, como introducimos que tenemos puntuales? A modo de contraste o calibración? Que aporta otras cosas?}
