...
\section{Descripción general del producto}
    ...
    \subsection{Características de los usuarios finales}
        ...
        \todo[inline]{Algo que se te ocurra aqui Sandra?}
    ...
    \subsection{Restricciones generales}
        ...
        \todo[inline]{Añadimos aquí algo de los motores de base de datos?}
...
\section{Requisitos específicos}
    ...
    \subsection{Requisitos de usuario}
        ...
        \todo[inline]{No he añadido nada sobre el cuestionario de síntomas ya que no hacemos nada con él, fue "idea" de las psicólogas}
        ...
        \begin{enumerate}[label=\textbf{\texttt{RU-\arabic*}}]
            ...
            \todo[inline]{Estos niveles serían categóricos, no numéricos, matizar?}
    ...
    \subsection{Requisitos funcionales}
        ...
        \todo[inline]{los ---- separan los requisitos por el de usuario del que fueron derivados. Añadir trazabilidad?}
        \begin{enumerate}[label=\textbf{\texttt{RF-\arabic*}}]
            ...
            ----------
            \todo[inline]{Este orden nos fuerza a poner extracción y visualización, y en el de analista decir que se envian y poco más}
            \item La aplicación extraerá del dispositivo \gls{wearable} datos de distancia recorrida por el usuario.
            \item La aplicación extraerá del dispositivo \gls{wearable} datos de desnivel ganado por el usuario. \todo[inline]{es elevation gained pero suena horrible, mejor traducción?}
            \item La aplicación extraerá del dispositivo \gls{wearable} datos de las sesiones de ejercicio realizadas por el usuario.
            \item La aplicación extraerá del dispositivo \gls{wearable} datos de las plantas subidas \todo[inline]{es floors climbed pero suena horrible, mejor traducción?} por el usuario.
            ...
            ----------
            \todo[inline]{El requisito de usar la app sin internet no es una funcionalidad sin mi misma verdad? Sino no funcionales de rendimiento y consideraciones de diseño}

            ----------
            \todo[inline]{El requisito de interfaz guay deriva en interfaz de usuario y accesbilidad verdad?}
        ...
        \end{enumerate}
        \todo[inline]{Tenemos el concepto de ronda de cuestionarios, que está en base de datos como resultado de diseño, tiene sentido omitirlo ahora y presentarlo solo en el diseño?}
    ...
    \subsection{Requisitos no funcionales}
        ...
        \subsubsection{Interoperabilty}
            \todo[inline]{Hablamos aqui de las unidades de medida de los datos? Solo se me ocurre hablar de que al usar el framework nuestra app puede usar cualquier puslera pero eso ya está dicho, portabilidad vs interoperabilidad}
        ...
        \subsubsection{Seguridad (Safety)}
            \todo[inline]{Dónde meteríamos los requisitos de privacidad, como el de dar permisos? También permiso notificaciones}
            \begin{enumerate}[resume, label=\textbf{\texttt{RNF-\arabic*}}]
        ...
        \subsubsection{Usability}
            \begin{enumerate}[resume, label=\textbf{\texttt{RNF-\arabic*}}]
                ...
                \todo[inline]{Detallamos aqui que queremos móviles y tabletas tanto en horizontal como en vertical?}
...
\section{Requisitos de Interfaces Externas - WIP}
    ...
    \subsection{Interfaces Software - WIP}
        ...
        \begin{enumerate}[label=\textbf{\texttt{RIS-\arabic*}}]
            ...
            \todo[inline]{Aqui, restriccion, borramos?}
...
\section{[Temporal] Deberían aparecer}
    \begin{enumerate}
