...
\section{Descripción general del producto}
    ...
    \subsection{Perspectiva del producto}
        ...
        \todo[inline]{No damos nombres verdad?}
    ...
    \subsection{Dependencias}
        ...
        \begin{enumerate}[label=\textbf{DEP-\arabic*}]
            ...
            \todo[inline]{no entiendo esta redacción, Resp: El fabricante tiene que integrar su ecosistema con el SDK de Salud Conectada, es decir, facilitar la exportación de los datos en su aplicación de pulsera. Pero no es solo integrar esa capa, es que sus tipos de datos sean compatibles y se escriba regularme en el sdk.}
    ...
    \subsection{Requisitos funcionales}
        ...
        \begin{enumerate}[series=req-usuario,label=\textbf{\texttt{RU-\arabic*}}]
            ...
            \begin{enumerate}[series=req-funcionales,label=\textbf{\texttt{RF-\arabic*}}]
                ...
                \todo[inline]{V: Si quitamos la info de puntual en el primer requisito, como introducimos que tenemos puntuales? A modo de contraste o calibración? Que aporta otras cosas?}
